...
.method public static putDefault(Landroid/os/PersistableBundle;)V
    ...
    const-string v3, "carrier_international_roaming_exception_list_strings"

    invoke-virtual {p0, v3, v2}, Landroid/os/PersistableBundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V

    .line 831
    const-string v2, "mtk_default_enhanced_4g_mode_bool"

    const/4 v3, 0x1

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 833
    const-string v2, "mtk_use_administrative_apn_bool"
    ...
    .line 837
    const-string v2, "mtk_show_clir_setting_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 839
    const-string v2, "mtk_show_open_mobile_data_dialog_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 840
    const-string v2, "mtk_wfc_settings_ux_type_int"

    const/4 v4, -0x1

    invoke-virtual {p0, v2, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    .line 842
    const-string v2, "mtk_default_wfc_mode_int"
    ...
    .line 843
    const-string v2, "mtk_wfc_provisioning_supported_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 845
    const-string v2, "mtk_support_vt_ss_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 847
    const-string v2, "mtk_dialer_call_pull_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 849
    const-string v2, "mtk_allow_one_way_video_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 852
    const-string v2, "mtk_allow_cancel_video_upgrade_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 854
    const-string v2, "mtk_allow_auto_start_timer_for_cancel_upgrade_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 856
    const-string v2, "mtk_timer_for_cancel_upgrade_int"
    ...
    .line 858
    const-string v2, "mtk_timer_for_decline_upgrade_int"

    invoke-virtual {p0, v2, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    .line 861
    const-string v2, "support_pause_ims_video_calls_bool"
    ...
    .line 871
    const-string v2, "ims_pdn_sync_fail_cause_to_modem_bool"
    ...
    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v2, v4}, Landroid/os/PersistableBundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .line 882
    const-string v2, "mtk_carrier_ss_gsm_ut_support"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 883
    const-string v2, "mtk_carrier_ss_not_support_xcap"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 884
    const-string v2, "mtk_carrier_ss_tb_clir"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 885
    const-string v2, "mtk_carrier_ss_ims_nw_cw"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 886
    const-string v2, "mtk_carrier_ss_enable_xcap_http_response_409"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 887
    const-string v2, "mtk_carrier_ss_transfer_xcap_404"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 888
    const-string v2, "mtk_carrier_ss_not_support_call_identity"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 889
    const-string v2, "mtk_carrier_ss_re_register_for_cf"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 890
    const-string v2, "mtk_carrier_ss_support_save_cf_number"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 891
    const-string v2, "mtk_carrier_ss_query_cfu_again_after_set"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 892
    const-string v2, "mtk_carrier_ss_not_support_ocb"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 893
    const-string v2, "mtk_carrier_ss_not_support_wfc_ut"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 894
    const-string v2, "mtk_carrier_ss_need_check_data_enable"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 895
    const-string v2, "mtk_carrier_ss_need_check_data_roaming"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 896
    const-string v2, "mtk_carrier_ss_need_check_ims_when_roaming"
    ...
    invoke-virtual {p0, v4, v2}, Landroid/os/PersistableBundle;->putStringArray(Ljava/lang/String;[Ljava/lang/String;)V

    .line 902
    const-string v2, "mtk_ct_volte_status_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 904
    const-string v2, "mtk_key_roaming_bar_guard_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 906
    const-string v2, "mtk_carrier_nouth_america_high_priority_clir_prefix_supported"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 908
    const-string v2, "mtk_carrier_swap_conference_to_foreground_before_merge"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 909
    const-string v2, "mtk_carrier_update_dialing_address_from_pau"
    ...
    .line 911
    const-string v2, "mtk_carrier_ims_ecbm_supported"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 912
    const-string v2, "mtk_carrier_notify_bad_wifi_quality_disconnect_cause"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 913
    const-string v2, "mtk_video_call_background_transmission"
    ...
    .line 915
    const-string v2, "mtk_carrier_blind_assured_ect_supported"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 916
    const-string v2, "mtk_carrier_consultative_ect_supported"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 917
    const-string v2, "mtk_carrier_device_switch_supported"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 918
    const-string v2, "mtk_key_restore_address_for_ims_conference_participants"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 919
    const-string v2, "mtk_key_operate_ims_conference_participants_by_user_entity"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 920
    const-string v2, "mtk_key_conference_first_participant_as_host_supported"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 921
    const-string v2, "mtk_single_call_after_conference_srvcc"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 924
    const-string v2, "default_dns_enabled_bool"
    ...
    .line 928
    const-string v2, "wos_flight_mode_support_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 931
    const-string v2, "mtk_carrier_wfc_mode_domestic_roaming_to_home"
    ...
    .line 937
    const-string v2, "mtk_carrier_disable_wfc_after_auth_fail_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 939
    const-string v2, "carrier_avoid_cmas_list_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 942
    const-string v2, "show_toast_when_conference_full"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 945
    const-string v2, "no_merge_req_after_max_connection"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 948
    const-string v2, "mtk_key_carrier_need_show_roaming_icon"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 951
    const-string v2, "disable_vt_over_wifi_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 954
    const-string v2, "mtk_show_call_barring_password_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 958
    const-string v2, "allow_hold_call_during_emergency_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 961
    const-string v2, "gsm_cdma_calls_can_be_hd_audio"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 964
    const-string v2, "mtk_key_multiline_allow_cross_line_conference_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 968
    const-string v2, "call_barring_visibility_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 971
    const-string v2, "no_sip_message_on_pause_video_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 974
    const-string v2, "mtk_vt_dialpad_support_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 977
    const-string v2, "mtk_resume_hold_call_after_active_call_end_by_remote"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 980
    const-string v2, "support_auto_decline_upgrade_request_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 983
    const-string v2, "mtk_key_update_wificalling_by_tty"
    ...
    .line 989
    const-string v2, "mtk_carrier_swap_vt_conference_to_foreground_before_merge"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 992
    const-string v2, "mtk_key_disconnect_all_calls_when_ecc_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 993
    const-string v2, "mtk_ims_video_conference_size_limit_int"
    ...
    .line 994
    const-string v2, "mtk_special_constraint_for_ims_video_conference"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 997
    const-string v2, "mtk_key_show_45g_options"
    ...
    .line 1000
    const-string v2, "rtt_upgrade_supported_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1001
    const-string v2, "rtt_downgrade_supported_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1003
    const-string v2, "mtk_rtt_video_switch_supported_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1005
    const-string v2, "mtk_rtt_auto_accept_request_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1007
    const-string v2, "mtk_multi_rtt_calls_supported_bool"
    ...
    .line 1016
    const-string v2, "mtk_vt_over_wifi_check_data_enable_bool"

    invoke-virtual {p0, v2, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1018
    const-string v2, "mtk_vt_over_wifi_check_wfc_enable_bool"

    invoke-virtual {p0, v2, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 1022
    const-string v2, "mtk_vt_over_wifi_check_volte_enable_bool"
    ...
    const-string v2, "com.coloros.locationproxy"
